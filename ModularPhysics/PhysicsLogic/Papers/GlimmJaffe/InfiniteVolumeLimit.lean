...
namespace ModularPhysics.Papers.GlimmJaffe.InfiniteVolumeLimit
...
open ModularPhysics.Core.QFT.Euclidean (EuclideanPoint IsOrthogonal)
...
end ModularPhysics.Papers.GlimmJaffe.InfiniteVolumeLimit
