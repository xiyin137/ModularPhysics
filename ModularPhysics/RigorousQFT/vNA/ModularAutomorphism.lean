...
def unitaryAt (σ : ModularAutomorphismGroup M Ω) (t : ℝ) : H →L[ℂ] H :=
  unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos t
...
theorem is_automorphism (σ : ModularAutomorphismGroup M Ω) (t : ℝ)
  ...
  have hmul1 : unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos (-t) ∘L
               unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos t = 1 :=
    unitaryGroup_neg_comp σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos t
  have hmul2 : unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos t ∘L
               unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos (-t) = 1 :=
    unitaryGroup_comp_neg σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos t
  ext x
  simp only [ContinuousLinearMap.comp_apply, neg_neg]
  -- U(-t) U(t) a U(-t) U(t) x = a x since U(-t) U(t) = 1
  have step1 : (unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos (-t) ∘L
                unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos t) x = x := by
    rw [hmul1]; simp
  have step2 : (unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos (-t) ∘L
                unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos t) (a x) = a x := by
    rw [hmul1]; simp
...
theorem group_law (σ : ModularAutomorphismGroup M Ω) (s t : ℝ)
  ...
  simp only [apply, unitaryAt]
  have hgroup := unitaryGroup_mul σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos
  ext x
  simp only [ContinuousLinearMap.comp_apply]
  -- U(s) U(t) a U(-t) U(-s) x = U(s+t) a U(-(s+t)) x
  have h1 : unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos s ∘L
            unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos t =
            unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos (s + t) := hgroup s t
  have h2 : unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos (-t) ∘L
            unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos (-s) =
            unitaryGroup σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos (-(s + t)) := by
    rw [hgroup (-t) (-s)]; ring_nf
  rw [← ContinuousLinearMap.comp_apply (unitaryGroup _ _ _ _ s),
      ← ContinuousLinearMap.comp_apply (unitaryGroup _ _ _ _ (-t)), h1, h2]

/-- σ_0 = id -/
theorem at_zero (σ : ModularAutomorphismGroup M Ω) (a : H →L[ℂ] H) (ha : a ∈ M) :
    σ.apply 0 a ha = a := by
  simp only [apply, unitaryAt]
  have h0 := unitaryGroup_zero σ.Δ σ.Δ_dense σ.Δ_selfadj σ.Δ_pos
...
theorem cocycle_unitary (c : ConnesCocycle M Ω₁ Ω₂) (t : ℝ) :
  ...
  have hinv1 := unitaryGroup_inv c.σ₁.Δ c.σ₁.Δ_dense c.σ₁.Δ_selfadj c.σ₁.Δ_pos t
  have hinv2 := unitaryGroup_inv c.σ₂.Δ c.σ₂.Δ_dense c.σ₂.Δ_selfadj c.σ₂.Δ_pos (-t)
